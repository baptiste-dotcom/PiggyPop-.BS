...
function resizeCanvas() {
  ...
  const maxCanvasHeight = document.documentElement.clientHeight * 0.95;
...
function spawnAnimal(columnX) {
  ...
  const speedMultiplier = Math.min(1 + currentScore / 1000, 5.5);
...
setInterval(() => {
  ...
  spawnAnimal(spacing * 0.3);   // colonne de gauche
  spawnAnimal(spacing * 1.5);   // colonne du centre
  spawnAnimal(spacing * 2.7);   // colonne de droite
}, 1500);
